...
import { FrontMenuModeMantenimiento } from "./types";

export const BuildingFrontMenuMantenimiento: FC<{
    mode: FrontMenuModeMantenimiento;
    open: boolean;
    ...
    const content = new Map<FrontMenuModeMantenimiento, any>();
